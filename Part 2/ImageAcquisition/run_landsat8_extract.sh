...
CUR_START_DATE='2018-01-01' # THIS SHOULD BE THE SAME AS IT IS IN ExtractLandsat8.py
NUM_IMGS=67 # The number of images that are downloaded per thread divided by 3 (given there are three biomes)
NUM_THREADS=50 
